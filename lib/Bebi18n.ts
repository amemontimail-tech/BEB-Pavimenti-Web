...
const it: Dictionary = {
  ...
  products: {
    ...
    productCategories: [
      ...
      { title: "Rubinetterie", desc: "Forme scultoree, linee eleganti e la migliore tecnologia per offrirti un'esperienza dell'acqua senza compromessi e un tocco di classe senza tempo.", imageId: "/prodotti/rubinetterie.webp" },
      { title: "Vasche", desc: "Autentiche sculture dedicate al tuo benessere fisico e mentale, progettate per essere le protagoniste indiscusse e lussuose della tua stanza da bagno.", imageId: "/prodotti/vasche.webp" },
      { title: "Carta da Parati", desc: "Texture, pattern e materiali esclusivi per pareti che diventano protagoniste dell'arredamento.", imageId: "/prodotti/carta-da-parati.webp" },
      { title: "Sanitari", desc: "Design ergonomico e linee pulite per sanitari che coniugano comfort assoluto e un'estetica moderna per il tuo bagno.", imageId: "/prodotti/sanitari.webp" },
      { title: "Parquet e Legno", desc: "Essenze pregiate accuratamente selezionate per pavimenti che trasmettono calore, eleganza naturale e una sensazione di puro comfort sotto i piedi.", imageId: "/prodotti/parquet-legno.webp" },
      ...
      { title: "Accessori Bagno", desc: "Il vero lusso risiede nei dettagli: accessori dal design esclusivo pensati per completare e arricchire la tua personale oasi di benessere quotidiano.", imageId: "/prodotti/accessori-bagno.webp" },
      ...
      { title: "Mobili da Bagno", desc: "Design esclusivo, finiture artigianali e materiali pregiati per arredare la sala da bagno con un'estetica ricercata e una funzionalità impeccabile.", imageId: "/prodotti/mobili-da-bagno.webp" }
    ],
