...
const it: Dictionary = {
  ...
  products: {
    ...
    productCategories: [
      ...
      { title: "Parquet e Legno", desc: "Essenze pregiate accuratamente selezionate per pavimenti che trasmettono calore, eleganza naturale e una sensazione di puro comfort sotto i piedi.", imageId: "/prodotti/parquet-legno.jpg" },
...
const en: Dictionary = {
  ...
  products: {
    ...
    productCategories: [
      ...
      { title: "Parquet & Wood", desc: "Carefully selected fine woods for floors that transmit warmth, natural elegance, and a sensation of pure comfort beneath your feet.", imageId: "/prodotti/parquet-legno.jpg" },
